    ...
    <main>
        ...
        <section class="bsis-banner">
            <div class="program-title">
                <div class="program-text">
                    ...
                    <i>"Manage the flow of information in a company."</i>
                </div>
            </div>
        </section>
        ...
        <section class="program-info" id="program-info">
            ...
            <p class="program-description">
                The BS Information Systems program includes the study of application and effect of information technology to organizations. Graduates of the program should be able to implement and information systems, which considers complex technological and organizational factors affecting it. These include components, tools, techniques, strategies, methodologies, etc.

                <br><br>

                Graduates are able to help an organization determine how information and technology-enabled business processes can be used as strategic tool to achieve a competitive advantage. As a result, IS professionals require a sound understanding of organizational principles and management/users communities within an organization. This enables them to ensure that the organization has the information and the systems it needs to support its opperations. 
            </p>
        </section>
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <li style="--cardColor:#05295D" class="w-100">
                            <div class="content">
                                <div class="title">IS01</div>
                                <div class="text">Apply knowledge of business processes, computing, mathematics and social sciences appropriate to Information Systems</div>
                            </div>
                        </li>
                        <li style="--cardColor:#06377A" class="w-100">
                            <div class="content">
                                <div class="title">IS02</div>
                                <div class="text">Analyze a problem. identify and define the computing requirements with respect to organizational factors appropriate to its solution and plan strategies for their solution </div>
                            </div>
                        </li>
                        <li style="--cardColor:#094699" class="w-100">
                            <div class="content">
                                <div class="title">IS03</div>
                                <div class="text">Evaluate information systems in terms of general quality attributes and possible trade-offs presented within the given requirement</div>
                            </div>
                        </li>
                        <li style="--cardColor:#0B53B9" class="w-100">
                            <div class="content">
                                <div class="title">IS04</div>
                                <div class="text">Design, implement, and evaluate information systems, processes, components, or programs and to source cost-benefit efficient alternatives  to meet desired needs, goals and constraints </div>
                            </div>
                        </li>
                        <li style="--cardColor:#0C5ECE" class="w-100">
                            <div class="content">
                                <div class="title">IS05</div>
                                <div class="text">Use knowledge and understanding of enterprises in modelling and design of information systems.</div>
                            </div>
                        </li>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <li style="--cardColor:#05295D" class="w-100">
                            <div class="content">
                                <div class="title">IS06</div>
                                <div class="text">Deploy and use effectively skills, tools and techniques necessary for information systems practice.</div>
                            </div>
                        </li>
                        <li style="--cardColor:#06377A" class="w-100">
                            <div class="content">
                                <div class="title">IS07</div>
                                <div class="text">Function effectively on teams(recognizing the different roles within a team and different ways of organizing teams) to accomplish a common goal.</div>
                            </div>
                        </li>
                        <li style="--cardColor:#094699" class="w-100">
                            <div class="content">
                                <div class="title">IS08</div>
                                <div class="text">Communicate effectively with a range of audiences. Communication skills includes techincal writing, presentation and neogitation, and numeracy.</div>
                            </div>
                        </li>
                        <li style="--cardColor:#0B53B9" class="w-100">
                            <div class="content">
                                <div class="title">IS09</div>
                                <div class="text">Recognize the legal, social, ethical and professional issues involved in the exploitation of computer technology and be guided by the adoption of appropriate professional, ethical and legal practices both in the local and global community.</div>
                            </div>
                        </li>
                        <li style="--cardColor:#0C5ECE" class="w-100">
                            <div class="content">
                                <div class="title">CS10</div>
                                <div class="text">Recognize the need for and engage in an independent and life-long learning, planning self-learning and improving performance as the foundation for on-going professional development.</div>
                            </div>
                        </li>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    ...
                    <ul>
                        ...
                        <li>Queality Assurance Specialist</li>
                    </ul>
                </div>
            </div>
        </section>
